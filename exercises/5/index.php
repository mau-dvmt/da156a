...
<ol>
    <li>Skapa layouten själva, börja då att läsa <a href="https://getbootstrap.com/docs/4.0/getting-started/introduction/">här</a></li>
    <li>Utgå från en färdig layout som bootstrap erbjuder, börja då att läsa <a href="https://getbootstrap.com/docs/4.0/examples/">här</a></li>
</ol>
<h4>2. Bildspel med komponenten <em>Carousel</em></h4>
<p>När ni fått en fram en webbsida som ni tycker ser bra ut är det dags för er att implementera ett bildspel. Bootstrap har en <a href="https://getbootstrap.com/docs/4.0/components/carousel/">komponent</a> som vi ska använda till detta. Ditt jobb är ni är nu att läsa dokumentationen för komponenten - och implementera bildspelet på din webbsida.
