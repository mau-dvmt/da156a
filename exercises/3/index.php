...
<p>Laborationen börjar med att vi testar på <code>float</code>, vilket är den älsta tekniken. <strong>För att bli godkänd på labben behöver ni göra layouten som beskrivs nedan genom båda teknikerna: <code>float</code> och <code>grid</code></strong>. Bonus (och väldigt bra träning) är att även göra den genom tekniken <code>flex</code></p>
