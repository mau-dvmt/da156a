...
<ol>
    ...
    <li>
        <p>Skapandet av ett HTML-dokument som innehåller texten. Det färdiga dokumentet validera, och bestå av element som väl beskriver innehållet.</p>
    </li>
...
<ul>
    ...
    <li>Följande CSS-egenskaper måste användas minst en gång: bakgrunds- och textfärg, typsnitt, textstorlek (ni får gärna använda egenskaper utöver dessa).</li>
</ul>

<h3>2. Redovisning</h3>

<p>Ditt resultat ska publiceras <strong>via WebShare och länken till webbsidan</strong> lämnas in på Canvas. Till inlämningen ska du även bifoga en kopia på alla webbplatsens filer (lämpligen genom en ZIP-fil). Deadline är söndag 29/9, klockan 23:59. Vid senare inlämning bedöms resultatet i samband med inlämningsuppgift 2.</p>
