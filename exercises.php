<?php
	...
	if(isset($_GET['title'])){
		...
		<div class="col-lg-8 create-submenu">
			<h2>Laborationer</h2>
			<p>Laborationer är rekommenderade övningsuppgifter, som tar upp många viktiga koncept på ett förklarande vis. Studenter kan titta på <a href="plan.php">planen för 2024</a> för handledningstider. Där syns också när respektive labb bör vara gjord, för att hålla kursens tempo.</p>
			...
			<table class="table table-striped">
                ...
                <tr>
                    <td>6</td>
                    <td>Att publicera webbsidor - Webbhotell</td>
                    <td>Anton</td>
                </tr>
			</table>
