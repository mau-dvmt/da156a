		...
		<div class="col-lg-8 create-submenu">
            ...
            <table class="table" id="plan">
                ...
                <tr class="lecture odd">
                    ...
                    <td>10/9</td>
                    <td>10-12</td>
                    <td>Föreläsning 3: <a href="/lectures.php?nr=2">Tabell &amp; formulär</a></td>
