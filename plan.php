		...
		<div class="col-lg-8 create-submenu">
            ...
            <table class="table" id="plan">
                ...
                <tr class="laboration odd">
					<td>10/10</td>
					<td>08-12</td>
					<td>Laboration: JavaScript på webben & Extratillfälle</td>
					<td></td>
				</tr>
                <tr class="tenta assignment odd">
                    <td>12/10</td>
